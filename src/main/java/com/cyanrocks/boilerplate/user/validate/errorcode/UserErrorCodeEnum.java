package com.cyanrocks.boilerplate.user.validate.errorcode;

import com.tobee.brains.common.exception.AppErrorCode;
...
public enum UserErrorCodeEnum {
     ...
     * 校验shopify签名失败
     */
    SHOPIFY_HMAC_VERIFY_FAIL(AppErrorCode.USER.getCode() + "100014"),
    /**
     * SHOPIFY 店铺没绑定
     */
    SHOPIFY_STORE_NOT_EXIST(AppErrorCode.USER.getCode() + "100015");
